    ...
    if ($admin_email) {
        $admin_body = mail_template(
            ...
            <p style="margin-top:20px;">
              <a href="' . $site_url . '/general-pest-removal/admin/contacts" style="background:#1e3a8a;color:#fff;padding:10px 20px;border-radius:8px;text-decoration:none;font-size:14px;font-weight:600;">View in Admin Panel</a>
            </p>',
            $biz_name
        );
