...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-12 text-center text-gray-400">
            ...
            <a href="/sydney-pest-removal/admin/blogs/edit" class="bg-primary text-white px-5 py-2 rounded-lg font-bold hover:bg-blue-900 transition">Create First Post</a>
        </div>
        <?php else: ?>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        <div class="flex items-center gap-2 flex-wrap">
                            <a href="/sydney-pest-removal/admin/blogs/edit?id=<?= $p['id'] ?>" class="text-primary hover:underline text-xs font-bold">Edit</a>
                            <a href="/sydney-pest-removal/blog/<?= htmlspecialchars($p['slug']) ?>" target="_blank" class="text-gray-400 hover:text-primary text-xs">View</a>
