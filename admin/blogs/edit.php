    ...
    if (empty($data['slug']) || empty($data['title'])) {
        ...
        try {
            if ($is_edit && $post) {
                ...
                header("Location: /admin/blogs/edit?id={$new_id}&saved=1");
                exit;
            }
...
<main class="flex-grow p-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center gap-4 mb-8">
            <a href="/admin/blogs" class="text-gray-400 hover:text-primary transition">
        ...
        <form method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex justify-between">
                <a href="/admin/blogs" class="text-gray-400 hover:text-gray-600 py-2.5 transition">← Back to Posts</a>
