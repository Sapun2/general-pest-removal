    ...
    if (empty($name) || empty($slug)) {
        ...
        try {
            if ($is_edit && $service) {
                ...
                header("Location: /sydney-pest-removal/admin/services/edit?id={$new_id}&saved=1");
                exit;
            }
...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        <a href="/sydney-pest-removal/admin/services" class="text-gray-400 hover:text-primary transition">
    ...
    <form method="POST" enctype="multipart/form-data" class="space-y-6" id="service-form">
        ...
        <div class="flex justify-between">
            <a href="/sydney-pest-removal/admin/services" class="text-gray-400 hover:text-gray-600 py-2.5 transition">← Back to Services</a>
