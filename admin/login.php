...
<div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8">
        ...
        <p class="text-xs text-gray-400 text-center mt-6">
            First time? <a href="/admin/setup" class="text-primary underline">Run DB Setup</a> to create the admin account.
        </p>
    </div>
    <p class="text-center mt-4 text-sm text-gray-500">
        <a href="/" class="hover:text-primary transition">← Back to Website</a>
    </p>
</div>
</body>
</html>
